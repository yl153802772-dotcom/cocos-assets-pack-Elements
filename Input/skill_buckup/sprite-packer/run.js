...
const TEMPLATES = {
    monster: {
        ...
        description: "怪物命名: monster_[元素]_[等级]_[动作]_[帧序号] (等级: t1~t5)"
    },
    bullet: {
        name: "子弹",
        ...
        description: "子弹命名: bullet_[元素]_[等级]_[帧序号] (等级: t1~t5)"
    },
    tower: {
        name: "塔",
        ...
        description: "塔命名: tower_[元素]_[等级]_[帧序号] (等级: t1~t5)"
    },
    effect: {
        name: "特效",
